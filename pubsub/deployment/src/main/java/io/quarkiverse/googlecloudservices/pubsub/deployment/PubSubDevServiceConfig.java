...
/**
 * Configuration group for the PubSub. This class holds all the configuration properties
 * related to the Google Cloud PubSub service for development environments.
 * <p>
...
public class PubSubDevServiceConfig {
    ...
    /**
     * Indicates whether the PubSub service should be enabled or not.
     ...
     * This image is used to emulate the PubSub service in the development environment.
    ...
    /**
     * Specifies the emulatorPort on which the PubSub service should run in the development environment.
     */
