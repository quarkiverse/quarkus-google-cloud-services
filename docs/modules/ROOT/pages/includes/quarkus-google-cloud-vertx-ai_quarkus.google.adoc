...
a| [[quarkus-google-cloud-vertx-ai_quarkus-google-cloud-vertexai-location]] [.property-path]##link:#quarkus-google-cloud-vertx-ai_quarkus-google-cloud-vertexai-location[`quarkus.google.cloud.vertexai.location`]##
...
a| [[quarkus-google-cloud-vertx-ai_quarkus-google-cloud-vertexai-api-endpoint]] [.property-path]##link:#quarkus-google-cloud-vertx-ai_quarkus-google-cloud-vertexai-api-endpoint[`quarkus.google.cloud.vertexai.api-endpoint`]##
ifdef::add-copy-button-to-config-props[]
